...
#include "can_packet/msg/detail/can_packet__rosidl_typesupport_fastrtps_c.h"
...
#include "can_packet/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _CanPacket__ros_msg_type = can_packet__msg__CanPacket;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_can_packet
size_t get_serialized_size_can_packet__msg__CanPacket(
  const void * untyped_ros_message,
...
static uint32_t _CanPacket__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_can_packet__msg__CanPacket(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_can_packet
size_t max_serialized_size_can_packet__msg__CanPacket(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = can_packet__msg__CanPacket;
    is_plain =
      (
...
static size_t _CanPacket__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_can_packet__msg__CanPacket(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, can_packet, msg, CanPacket)() {
