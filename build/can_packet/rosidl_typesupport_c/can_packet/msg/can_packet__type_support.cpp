...
static const _CanPacket_type_support_symbol_names_t _CanPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, can_packet, msg, CanPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, can_packet, msg, CanPacket)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, can_packet, msg, CanPacket)() {
  return &::can_packet::msg::rosidl_typesupport_c::CanPacket_message_type_support_handle;
}
