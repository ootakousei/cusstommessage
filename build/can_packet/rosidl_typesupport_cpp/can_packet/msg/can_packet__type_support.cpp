...
static const _CanPacket_type_support_symbol_names_t _CanPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, can_packet, msg, CanPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, can_packet, msg, CanPacket)),
  }
};
...
{
  return &::can_packet::msg::rosidl_typesupport_cpp::CanPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, can_packet, msg, CanPacket)() {
  return get_message_type_support_handle<can_packet::msg::CanPacket>();
}
